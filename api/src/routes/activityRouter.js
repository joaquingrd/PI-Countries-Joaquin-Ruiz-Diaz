...
const { createActivity, getAllActivity } = require("../controllers/activityControllers")
...
activityRouter.post('/', async (req, res) => {
    ...
    try {
        let activityCreate = await createActivity(name, difficulty, duration, season, countryId)
